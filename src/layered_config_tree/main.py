...
class ConfigNode:
    ...
    def __init__(self, layers: List[str], name: str) -> None:
        self._name = name
        self._layers = layers
...
class LayeredConfigTree:
    ...
    def __init__(
        self,
        data: Optional[
            Union[Dict[str, Any], str, Path, "LayeredConfigTree"]
        ] = None,
    ...
    def update(
        self,
        data: Optional[Union[Dict, str, Path, "LayeredConfigTree"]],
    ...
    @staticmethod
    def _coerce(
        data: Union[Dict[str, Any], str, Path, "LayeredConfigTree"], source: Optional[str]
        ...
        if isinstance(data, dict):
            ...
            with open(data) as f:
                data = f.read()
            return yaml.full_load(data), source
